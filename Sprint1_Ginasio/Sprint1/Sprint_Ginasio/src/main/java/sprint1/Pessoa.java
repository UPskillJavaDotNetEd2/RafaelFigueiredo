...
public class Pessoa implements Comparable <Pessoa> {
    ...
    public void setIdentificador(String identificador) {
        if (!isUpperCase(identificador.charAt(0))) {
            throw new IdentificadorInvalidoException(String.format("ERRO: Este identificador: %s é inválido.", identificador));
        }
        this.identificador = identificador;
    }
    /**
    ...
    public final void setNome(String nome) {
        if(nome==null || nome.trim().isEmpty())
            throw new NomeInvalidoException(String.format("O nome %s é inválido!", nome));
        this.nome = nome;
    }
    /**
     * Modifica a morada
    ...
    public void setMorada(String morada) {
        if(morada==null || morada.trim().isEmpty())
            throw new MoradaInvalidaException(String.format("A morada %s é inválida!", morada));
        this.morada = morada;
    }
    /**
     * Modifica o género
    ...
    public void setGenero(String c){
        ...
        if(!f){
            throw new GeneroInvalidoException(String.format("Erro: Esta categoria: %s é inválida!", c));
        }
    }
    /**
