...
public class  Convidado extends Cliente implements  PagamentoSessoesPT, HorasExtraAulas, CustoAulas{
    ...
    public Convidado(String nome, String morada, Genero genero, Data dataNascimento, float altura, int peso, int numeroAulas, int numeroAulasHidroginastica, int numeroHorasPermanecimento, int numeroSessoes, double custoPorSessao, int bancoHoras) throws NumeroDeSessoesInvalidoException, NumeroHorasPermanecimentoException {
        ...
        if (numeroHorasPermanecimento < 0){
            throw new NumeroHorasPermanecimentoException();
        }
    ...
    public double custoAulas() {
        double custoAulas = 0;
        if (getNumeroAulas() > 0 || precoAulaHidroginastica<0 ) {
